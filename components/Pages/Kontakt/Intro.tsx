    ...
    <div>
       <section className="relative flex flex-col gap-10 lg:gap-16 xl:gap-24 small">
        <div className="flex flex-col gap-6 text-center md:gap-8 lg:gap-16">
          ...
          <span className="kicker">Kärleksbrev? Till oss?</span>
          <span className="louder balance">Kontakta oss</span>
          </h1>
          <div className="relative mx-auto max-w-[95rem]">
            <p className="mx-auto leading-tight xl:leading-[1.1] sm:text-3xl md:text-4xl lg:text-5xl balance">Frågor om restaurang, meny och samarbeten: <Link className='hover:italic' href="mailto:hej@husetunderbarhimmel.se">hej@husetunderbarhimmel.se</Link> eller kontaktformuläret nedan.</p>
